              ...
              {leaderboard.map((user, idx) => (
                ...
                >
                  ...
                  <td className={`p-3 font-medium flex items-center gap-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                    ...
                    {/* REMOVED truncate and max-w to show full name */}
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2">
                               ...
                               <span className={`font-bold truncate max-w-[100px] ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{player.name} {player.email === user.email && '(You)'}</span>
                            </div>
                        </div>
